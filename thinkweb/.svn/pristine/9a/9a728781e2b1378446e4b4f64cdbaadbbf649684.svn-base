...
import com.mps.think.setup.util.PropertyUtils;
	...
	public class sourceCodeDetailMapper implements RowMapper<sourceCodeModel> {

		private static final Logger LOGGER = LoggerFactory.getLogger(sourceCodeModel.class);
		
		@Override
		public sourceCodeModel mapRow(ResultSet rs, int rowNum) throws SQLException {
			sourceCodeModel parentModel = new sourceCodeModel();
			try {
