...
public class Payment  extends Think.XmlWebServices.ZZPayment  implements java.io.Serializable {
	...
	public String toString() {
		return "Payment [auxiliary_data=" + Arrays.toString(auxiliary_data) + ", initial_deposit_pay_amt="
				+ initial_deposit_pay_amt + ", initial_deposit_base_amt=" + initial_deposit_base_amt
				+ ", customer_deposit_base_amt=" + customer_deposit_base_amt + ", cc_used_up_settle_retries="
				+ cc_used_up_settle_retries + ", cc_settle_retries_do_suspend=" + cc_settle_retries_do_suspend
