...
public interface PaymentInfoDao {
	...
	// public List<OrderDetailsModel> viewOrderItemsList(int orderhdr_id, int order_item_seq);
	...
	public List<CustomerOrderPayment> viewOrderItemsListForDepPay(int orderId, int orderItemSeq, int customer_id);
