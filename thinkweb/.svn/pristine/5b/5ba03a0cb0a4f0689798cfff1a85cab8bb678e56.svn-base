...
public class ProcessMapper implements RowMapper<ProcessModel> {
	...
	public ProcessModel mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		processModel.setInstallmentPlanId(rs.getString("all_installment_plans"));
		...
		processModel.setIncludeAll(rs.getInt("all_installment_plans")!=0?rs.getInt("all_installment_plans"):0);
		}catch(Exception e) {
