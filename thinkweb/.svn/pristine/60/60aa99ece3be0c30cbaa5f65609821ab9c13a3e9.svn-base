...
public class ZZOrderItemAmtBreak  implements java.io.Serializable {
	...
	public String toString() {
		return "ZZOrderItemAmtBreak [orderhdr_id=" + orderhdr_id + ", order_item_seq=" + order_item_seq
				+ ", order_item_amt_break_seq=" + order_item_amt_break_seq + ", base_amount=" + base_amount
				+ ", effective_date=" + effective_date + ", jurisdiction_seq=" + jurisdiction_seq + ", local_amount="
				+ local_amount + ", order_item_break_type=" + order_item_break_type + ", orig_base_amount="
				+ orig_base_amount + ", state=" + state + ", tax_active=" + tax_active + ", tax_delivery="
				+ tax_delivery + ", tax_rate=" + tax_rate + ", tax_rate_category=" + tax_rate_category + ", tax_type="
				+ tax_type + ", tx_incl=" + Arrays.toString(tx_incl) + ", vrtx_jurisdiction=" + vrtx_jurisdiction
				+ ", vrtx_jurisdiction_level=" + vrtx_jurisdiction_level + ", vrtx_tax_type=" + vrtx_tax_type
