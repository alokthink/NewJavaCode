...
public class Payment_add_data  extends Think.XmlWebServices.ZZPaymentData  implements java.io.Serializable {
	...
	public String toString() {
		return "Payment_add_data [customer_identifier=" + customer_identifier
				+ ", bill_to_address_of=" + bill_to_address_of
				+ ", use_deposit=" + use_deposit + ", sum_amt_due="
				+ sum_amt_due + ", payment_info_option=" + payment_info_option
				+ ", credit_card_authorization=" + credit_card_authorization
				+ ", auth_credit_card_override=" + auth_credit_card_override
				+ ", accept_expired_card=" + accept_expired_card
				+ ", ecommerce_payment=" + ecommerce_payment
				+ ", credit_card_recurring=" + credit_card_recurring
				+ ", event_queue_oc_id=" + event_queue_oc_id
