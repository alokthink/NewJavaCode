...
public class CancelOrderDetailsMapper implements  RowMapper<CancelOrderDetailsModel>{
	...
	public CancelOrderDetailsModel mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		cancelOrderDetailsModel.setAgency_customer_id(rs.getString("agency_customer_id"));
		cancelOrderDetailsModel.setCustomer_address_seq(rs.getString("customer_address_seq"));
		cancelOrderDetailsModel.setPayment_status(rs.getString("payment_status"));
