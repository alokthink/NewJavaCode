...
public class Customer_identifier  implements java.io.Serializable {
	...
	public String toString() {
		return "Customer_identifier [customer_id=" + customer_id + ", login=" + login + ", password=" + password
				+ ", authentication_code=" + authentication_code + ", target_element=" + target_element + ", role="
				+ role + ", __equalsCalc=" + __equalsCalc + ", __hashCodeCalc=" + __hashCodeCalc + "]";
	}
