...
public interface OrderFunctionalityService {
	...
	public List<DropdownModel> getRateBackDetails(String rateClass);
	...
	public int saveDealOrderCodeDetails(GropDealModel gropDealModel);
