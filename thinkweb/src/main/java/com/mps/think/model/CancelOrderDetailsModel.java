...
public class CancelOrderDetailsModel 
{
	...
	//Added by Sohrab For THINKDEV-610,611,615,1115,1129
	private String agency_customer_id;
	private String customer_address_seq;
	private List<String>agency_data_list;
	...
	public List<String> getAgency_data_list() {
		return agency_data_list;
	}
	public void setAgency_data_list(List<String> agency_data_list) {
		this.agency_data_list = agency_data_list;
	}
