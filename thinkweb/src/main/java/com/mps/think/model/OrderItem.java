...
public class OrderItem 
{
	...
	private String effective_expire_date;
	...
	private int unitUse;
	private Integer installmentIdNew;
	...
	private int ratecard_seq;
	
	//order_item_amt_break table
	private int order_item_amt_break_seq;
	private String effective_date;
	private int jurisdiction_seq;
	private int order_item_break_type;
	private String orig_base_amount;
	//private String state;
	private int tax_active;
	private int tax_delivery;
	private String tax_rate;
	private String tax_rate_category;
	private String tax_type;
	private byte tx_incl;
	private String vrtx_jurisdiction;      
	private String vrtx_jurisdiction_level;      
	private String vrtx_tax_type; 
	private List<OrderItem> packageMemberList;
	private List<CancelOrderAttributeModel> cancelOrderList;
	private List<Map<String, Object>> auxiliaryFieldList;	
	private int itemCount;
	private String subscriptionIdList[];
	private String pkgDef;
	private String threshold_option;
	private int required;
	private int auxFlag;
	private Optional<Integer> changeAmount;
	
	public Optional<Integer> getChangeAmount() {
		return changeAmount;
	}

	public void setChangeAmount(Optional<Integer> changeAmount) {
		this.changeAmount = changeAmount;
	}

	public int getAuxFlag() {
		return auxFlag;
	}

	public void setAuxFlag(int auxFlag) {
		this.auxFlag = auxFlag;
	}

	public List<Map<String, Object>> getAuxiliaryFieldList() {
		return auxiliaryFieldList;
	}

	public void setAuxiliaryFieldList(List<Map<String, Object>> auxiliaryFieldList) {
		this.auxiliaryFieldList = auxiliaryFieldList;
	}
	
	public List<OrderItem> getPackageMemberList() {
	...
	public void setPackageMemberList(List<OrderItem> packageMemberList) {
		this.packageMemberList = packageMemberList;
	}

	public List<CancelOrderAttributeModel> getCancelOrderList() {
		return cancelOrderList;
	}

	public String[] getSubscriptionIdList() {
		return subscriptionIdList;
	}

	public void setSubscriptionIdList(String[] subscriptionIdList) {
		this.subscriptionIdList = subscriptionIdList;
	}

	public void setCancelOrderList(List<CancelOrderAttributeModel> cancelOrderList) {
	...
	public String getOrig_base_amount() {
		return orig_base_amount;
	}

	public void setOrig_base_amount(String orig_base_amount) {
	...
	public String getTax_rate_category() {
		return tax_rate_category;
	}

	public void setTax_rate_category(String tax_rate_category) {
	...
	public String getVrtx_jurisdiction() {
		return vrtx_jurisdiction;
	}

	public void setVrtx_jurisdiction(String vrtx_jurisdiction) {
		this.vrtx_jurisdiction = vrtx_jurisdiction;
	}

	public String getVrtx_jurisdiction_level() {
		return vrtx_jurisdiction_level;
	}

	public void setVrtx_jurisdiction_level(String vrtx_jurisdiction_level) {
		this.vrtx_jurisdiction_level = vrtx_jurisdiction_level;
	}

	public String getVrtx_tax_type() {
		return vrtx_tax_type;
	}

	public void setVrtx_tax_type(String vrtx_tax_type) {
	...
	public int getRatecard_id() {
		return ratecard_id;
	}

	public void setRatecard_id(int ratecard_id) {
	...
	public String getEffective_expire_date() {
		return effective_expire_date;
	}

	public void setEffective_expire_date(String effective_expire_date) {
		this.effective_expire_date = effective_expire_date;
	}
	...
	public Integer getInstallmentIdNew() {
		return installmentIdNew;
	}

	public void setInstallmentIdNew(Integer installmentIdNew) {
	...
	public String toString() {
		return "OrderItem [orderhdrId=" + orderhdrId + ", orderItemSeq=" + orderItemSeq + ", deliveryMethod="
				...
				+ NQP + ", NQF=" + NQF + ", customerDistributionValues=" + customerDistributionValues+ ",cancelledOrderAmount=" + cancelledOrderAmount+ ",payment_type=" + payment_type+",threshold_option=" + threshold_option+",pkgDef=" + pkgDef+"]";
	}
}