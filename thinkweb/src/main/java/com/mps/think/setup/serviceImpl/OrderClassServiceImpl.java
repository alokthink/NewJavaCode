...
public class OrderClassServiceImpl implements OrderClassService {
	...
	public List<sourceCodeModel> getSourceCodeDetails(Long ocId, int active, String sourceCodeType, int isDDp, String sourceCode) {
		return orderClassDetailsDao.getSourceCodeDetails(ocId,active,sourceCodeType, isDDp, sourceCode);
	}
	@Override
	public List<ParentOrderClassModel> getSourceCodeDetails1(String sourceCodeId){
		return orderClassDetailsDao.getSourceCodeDetails1(sourceCodeId);
	}
	@Override
	...
	public List<UpSellModel> getUpSellTableData(int ocId){
		return orderClassDetailsDao.getUpSellTableData(ocId);
	}
	@Override
	...
	public Map<String, Object> getRateCardCopyDetails(Integer rate_class_id,Integer rate_class_effective_seq) {
		return orderClassDetailsDao.getRateCardCopyDetails(rate_class_id,rate_class_effective_seq);
	}
	...
	public List<Map<String, Object>> searchRateClass(long ocId, String rateDescription) {
		return orderClassDetailsDao.searchRateClass(ocId, rateDescription);
	}
	...
	public List<Map<String, Object>> searchDiscountClass(long ocId, String discountDescription) {
		return orderClassDetailsDao.searchDiscountClass(ocId, discountDescription);
	}
	...
	public List<DropdownModel> getSourceCodeAttribute(String sourceFormat) {
		return orderClassDetailsDao.getSourceCodeAttribute(sourceFormat);
	}

	@Override
	public List<DropdownModel> getAttributeValue(String sourceAttribute) {
		return orderClassDetailsDao.getAttributeValue(sourceAttribute);
	}

	@Override
	public List<Map<String, Object>> getState(String sourceCodeId) {
		return orderClassDetailsDao.getState(sourceCodeId);
	}

	@Override
	public List<Map<String, Object>> getAttributeDetails(String sourceCodeId) {
		return orderClassDetailsDao.getAttributeDetails(sourceCodeId);
	}

	@Override
	public List<Map<String, Object>> getOcDetails() {
		return orderClassDetailsDao.getOcDetails();
	}

	@Override
	public List<Map<String, Object>> searchSourceCode(long ocId, int active,int sourceCodeType) {
		return orderClassDetailsDao.searchSourceCode(ocId, active, sourceCodeType);
	}
	
	@Override
	public List<Map<String, Object>> searchSourceCode(long ocId, int active,int sourceCodeType,String sourceCode) {
		return orderClassDetailsDao.searchSourceCode(ocId, active, sourceCodeType,sourceCode);
	}
	
	@Override
	public List<Map<String, Object>> getAuditDetails(String sourceCodeId) {
		return orderClassDetailsDao.getAuditDetails(sourceCodeId);
	}

	@Override
	public List<Map<String, Object>> searchSourceCode(long ocId, int active, int sourceCodeType, String sourceCode,Long ocId2) {
		
		return orderClassDetailsDao.searchSourceCode(ocId, active, sourceCodeType, sourceCode, ocId2);
	}

	@Override
	public List<Map<String, Object>> searchSourceCode(long ocId, int active, int sourceCodeType, Integer flag) {
		return orderClassDetailsDao.searchSourceCode(ocId, active, sourceCodeType, flag);
	}

	@Override
	public List<Map<String, Object>> searchSourceCode(long ocId, int active, int sourceCodeType, String sourceCode,
			Long ocId2, Integer flag) {
		return orderClassDetailsDao.searchSourceCode(ocId, active, sourceCodeType, sourceCode, ocId2, flag);
	}

	@Override
	public List<Map<String, Object>> getPromotionCardDetails(int promoCardId) {
		return orderClassDetailsDao.getPromotionCardDetails(promoCardId);
	}

	@Override
	public int getOcType(long ocId) {
		return orderClassDetailsDao.getOcType(ocId);
	}

	@Override
	public List<Map<String, Object>> searchSourceCodeFromOfferList(Long ocId, int active, int sourceCodeType, String offer) {
		return orderClassDetailsDao.searchSourceCodeFromOfferList(ocId, active, sourceCodeType, offer);
	}

	@Override
	public List<Map<String, Object>> searchSourceCodeFromOfferList(long ocId, int active, int sourceCodeType, String list) {
		return orderClassDetailsDao.searchSourceCodeFromOfferList(ocId, active, sourceCodeType, list);
	}
	@Override
	public List<Map<String, Object>> searchSourceCodeFromOfferList(long ocId, int active, int sourceCodeType,long ocId2) {
		return orderClassDetailsDao.searchSourceCodeFromOfferList(ocId, active, sourceCodeType, ocId2);
	}
	...
	public List<Map<String, Object>> searchSourceCodeFromOfferList(long ocId, int active, int sourceCodeType, String offer,String list, Long ocId2) {
		return orderClassDetailsDao.searchSourceCodeFromOfferList(ocId, active, sourceCodeType, offer, list, ocId2);
	}

	@Override
	public List<Map<String, Object>> addressLookUp() {
		return orderClassDetailsDao.addressLookUp();
	}

	@Override
	public List<Map<String, Object>> addressLookUp(Long ocId, int active, int sourceCodeType, Integer addressId,String Description) {
		return orderClassDetailsDao.addressLookUp(ocId, active, sourceCodeType, addressId, Description);
	}

	@Override
	public int deletePromotionOffer(int promotionCardId, int promotionCardFromEffort, int promotionCardOfferSeq) {
		return orderClassDetailsDao.deletePromotionOffer(promotionCardId, promotionCardFromEffort, promotionCardOfferSeq);
	}

	@Override
	public String deletePromotionCardFromEffort(int promotionCardId, int promotionCardFromEffort) {
		return orderClassDetailsDao.deletePromotionCardFromEffort(promotionCardId, promotionCardFromEffort);
	}

	@Override
	public String deletePromotionCard(int promotionCardId) {
		return orderClassDetailsDao.deletePromotionCard(promotionCardId);
	}

	@Override
	public List<Map<String, Object>> searchSubscriptionDef(int orderCodeId, Integer inactive,
			String description, Integer termId, String media, Integer categoryId,String action) {
		return orderClassDetailsDao.searchSubscriptionDef(orderCodeId, inactive, description, termId, media, categoryId,action);
	}
	...
	public List<Map<String, Object>> searchPkgDef(int orderCodeId, Integer active, Integer pkgDefId, String pkgDef,String description,String action) {
		return orderClassDetailsDao.searchPkgDef(orderCodeId, active, pkgDefId, pkgDef, description,action);
	}
	...
	public List<Map<String, Object>> searchProduct(int orderCodeId, String description, String style, String size,String color, String action) {
		return orderClassDetailsDao.searchProduct(orderCodeId, description, style, size, color, action);
	}

	@Override
	public List<Map<String, Object>> getAuditCategory(int ocId) {
		return orderClassDetailsDao.getAuditCategory(ocId);
	}
