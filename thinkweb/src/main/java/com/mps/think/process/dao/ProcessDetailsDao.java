...
public interface ProcessDetailsDao {
	...
	List<Map<String, Object>> getSplit(Integer processId);

	int saveSplit(SplitDetailModel splitDetailModel);

	int updateSplit(SplitDetailModel splitDetailModel);

	List<DropdownModel> getExtract();

	int deleteSplit(Integer processId);
