...
//			responseObject.put("efforts", efforts);
	...
	@RequestMapping(path = "/renTestingProgressSave", method = RequestMethod.POST)
	public Map<String, Object> renTestingProgressSave(String nthDef,String description,String renewalDef,Integer renewalDefTestSeq ) {
		Map<String, Object> responseObject = new LinkedHashMap<>();

		try {
			String renTestingProgressSave = processSaveService.getRenTestingProgressSave(nthDef,description,renewalDef,renewalDefTestSeq);
			responseObject.put("renTestingProgressSave", renTestingProgressSave);
			responseObject.put(STATUS, SUCCESS);
