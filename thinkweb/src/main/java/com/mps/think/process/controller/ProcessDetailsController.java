...
//select * from renewal_def_test where renewal_def='Aabc'
 @PostMapping("/editRenTestingProgress")
  public Map<String, Object> editRenTestingProgress(String renewalDef) {
	 Map<String, Object> responseObject = new LinkedHashMap<>();
	try {
		List<Map<String, Object>> editRenTestingData = processDetailService
				.getEditRenTestingData(renewalDef);
		responseObject.put("editRenTestingData", editRenTestingData);
		return responseObject;
		} catch (Exception e) {
			LOGGER.error(ERROR, e);
			responseObject.put(STATUS, ERROR + e);
