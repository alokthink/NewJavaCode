...
public class ProcessDetailsServiceImp implements ProcessDetailsService {
	...
	@Autowired
	ProcessDetailsDao processDetailsDao;
	...
	public List<Map<String, Object>> allProcess() {
		return processInfoDao.allProcess();
	}
	...
	public List<Map<String, Object>> getProcess(String billingDef) {
		return processInfoDao.getProcess(billingDef);
	}

	@Override
	public List<Map<String, Object>> getOrders(String billingDef) {
		return processInfoDao.getOrders(billingDef);
	}

	@Override
	public boolean getGeneratedBillCode(String billingDef) {
		return processInfoDao.getGeneratedBillCode(billingDef);
	}

	/*
	 * @Override public List<Map<String, Object>> getBillOrderClassDetails(String
	 * billingDef,) { return processInfoDao.getBillOrderClassDetails(billingDef); }
	 */

	@Override
	public List<Map<String, Object>> getBillOrderClassInfo(String billingDef) {
		return	processInfoDao.getBillOrderClassInfo(billingDef);
		
	}

	@Override
	public List<Map<String, Object>> getBillOrd(String billingDef) {
		return processInfoDao.getBillOrd(billingDef);
	}

	@Override
	public Object getOrderDetailsTypeForSelected(String renewalDef) {
		 return processInfoDao.getOrderDetailsTypeForSelected(renewalDef);	}

	@Override
	public List<Map<String, Object>> getBillOrderClassDetails(String billingDef, String showAllOc) {
		return processInfoDao.getBillOrderClassDetails(billingDef,showAllOc);
	}

	@Override
	public List<Map<String, Object>> getEffortsDetails(String billingDef, String showAllPC) {
		return processInfoDao.getEffortsDetails(billingDef,showAllPC);
	}

	@Override
	public List<Map<String, Object>> getEffortBasedProcess(String billingDef, int effortNumber) {
		return processInfoDao.getEffortBasedProcess(billingDef,effortNumber);
	}
	
	@Override
	public List<Map<String, Object>> getshowProcessAll(String renewalDef) {
		 return processInfoDao.getshowProcessAll(renewalDef);
	}

	@Override
	public Object getOrderDetailsTypeForSelectedForAdd() {
		return processDetailsDao.getOrderDetailsTypeForSelectedForAdd();
	}

	@Override
	public List<DropdownModel> getProcessType() {
		return processInfoDao.getProcessType();
	}

	@Override
	public List<Map<String, Object>> getReconciliationProcessDetails(int processId) {
		return  processInfoDao.getReconciliationProcessDetails(processId);
	}

	@Override
	public List<DropdownModel> getDefaultJobQueue() {
		return   processInfoDao.getDefaultJobQueue();
	}
	@Override
	public List<Map<String, Object>> getProfitCenterDetails() {
		return processInfoDao.getProfitCenterDetails();
	}
	

	@Override
	public List<Map<String, Object>> jobDetails(int jobId) {
		return processInfoDao.jobDetails(jobId);
 	}

	@Override
	public List<Map<String, Object>> getEditRenTestingData(String renewalDef) {
		return processInfoDao.getEditRenTestingData(renewalDef);
	}
