...
public class ProcessSaveServiceImpl implements ProcessSaveService{
	...
	public String deleteBillingDef(String billingDef) {
		return processSaveDao.deleteBillingDef(billingDef);
	}
	...
	public String deleteBillingDefTet(String billingDef, int billingDefTestSeq) {
		return processSaveDao.deleteBillingDefTet(billingDef,billingDefTestSeq);
	}

	@Override
	public int addBillOrderClass(int ocId, String billingDef) {
		return processSaveDao.addBillOrderClass(ocId,billingDef);
	}

	@Override
	public int removeOrderClass(int ocId, String billingDef) {
		return processSaveDao.removeOrderClass(ocId,billingDef);
	}

	@Override
	public int removeInstallmentSave(int processId) {
		return processSaveDao.removeInstallmentSave(processId);
	}

	@Override
	public int addBillProcess(int processId, String billingDef, int effortNumber) {
		return processSaveDao.addBillProcess(processId,billingDef,effortNumber);
	}

	@Override
	public int removeBillProcess(int processId, String billingDef) {
		return processSaveDao.removeBillProcess(processId,billingDef);
	}

	@Override
	public String getRenTestingProgressSave(String nthDef, String description, String renewalDef,
			Integer renewalDefTestSeq) {
		return processSaveDao.getRenTestingProgressSave(nthDef,description,renewalDef,renewalDefTestSeq);
	}
