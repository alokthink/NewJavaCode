...
<div class="col-xs-12 col-sm-3 col-md-4 col-lg-3">
			   <div class="news-box">
					...
					<ul class="sideNav2">
						...
						<li class="active"><a href="DelTravel0.jsp">Delete Travels</a></li>
...
<FORM Name='DelForm' METHOD=POST ACTION="DelTravel1.jsp" onsubmit="return validate()">
			<CENTER><B><FONT face="verdana" color="black"> Select a Travel Id to delete from database </FONT></B></CENTER><BR><BR>
		 <center>
