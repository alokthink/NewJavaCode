...
<body >
<HR>
<B><FONT COLOR="RED" face='verdana' size="5"><center>Seat Selection</center></FONT></B>
<HR>
<BR><BR>
<FORM ACTION="">
<%
...
try
{
	...
	String[] Details = com.balaji.travels.MyFunctions.MyTokenizer(RouteSelected,"_");
	...
	String Qry1 = "Select Seats from ticketdetails where RouteId='"+RouteId+"' and BusId='"+BusId+"'";
...
<FONT COLOR="blue" face='verdana' size="3">Select your Boarding point</FONT> <FONT COLOR="red">*</FONT>
<SELECT NAME="BPoint" class="ListBox" value="<%=BPoints[0]%>">
	<%for(int i=0;i<NumRows;i++){%>
		<OPTION VALUE="<%=BPoints[i]%>"><%=BPoints[i]%></OPTION>
	<%}%>
</SELECT><BR><BR>
<FONT COLOR="blue" face='verdana' size="3">Choose your seats</FONT> <FONT COLOR="red">*</FONT>&nbsp;<INPUT TYPE="text" id="name" NAME="Seats" class="TextField">
<BR>
<FONT COLOR="#333399" size="-1" face='Times new roman'><I>select from the available seats from the layout below</I></FONT>
<H5>Bus Layout</H5>
<INPUT TYPE="image" SRC="Images/availableSeat.jpg"></IMG><FONT COLOR="grey" face='verdana'>Available</FONT>&nbsp;
<IMG SRC="Images/bookedSeat.gif" WIDTH="21" HEIGHT="17" BORDER="0" ALT=""></IMG><FONT COLOR="grey" face='verdana'>Booked</FONT>&nbsp;
<IMG SRC="Images/selectedSeat.gif" WIDTH="18" HEIGHT="17" BORDER="0" ALT=""></IMG><FONT COLOR="grey" face='verdana'>Selected</FONT>&nbsp;
<BR><BR>
<TABLE>
<TR>
...
<P align=right>
	<A onclick="setAction('BookNow_S2.jsp',this)" ><IMG SRC="Images/Continue1.jpg" border="0"
