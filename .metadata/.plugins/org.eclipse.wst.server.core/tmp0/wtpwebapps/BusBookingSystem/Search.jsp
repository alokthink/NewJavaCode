...
<body Class='SC'>
<HR>
<B><FONT COLOR="red" face='verdana' size= "6"><center>Select Bus</center></FONT></B>
<HR>
<BR><BR>
<FORM ACTION="">
...
try
{
	...
	String Qry = "select routemaster.RouteId,travelsmaster.Travels,travelsmaster.AgentName,travelsmaster.PhoneNumber,busmaster.BusType,busmaster.BusNumber,routemaster.Fare,routemaster.Departure,routemaster.Arrival,routemaster.TravelsId,routemaster.BusId from routemaster    RIGHT JOIN travelsmaster  on (routemaster.TravelsId=travelsmaster.TravelsId ) LEFT JOIN busmaster  on (routemaster.BusId=busmaster.BusId and  busmaster.BusType in ("+BusTypeCondition+")) where  routemaster.rFrom='"+rFrom+"' and routemaster.rTo='"+rTo+"' and routemaster.JDate='"+JDate+"' and routemaster.Availability >= "+NoPass;
		...
		while(rs.next())
			{
					...
					System.out.print(RouteId+Travels+AgentName+PhoneNumber+BusType+BusNumber);
					%>
			...
			%>
					...
					<P align=right>
						<A onclick="setAction('BookNow_S1.jsp',this)"><IMG SRC="Images/BookNow1.jpg" border="0"
						onmouseout="this.src = 'Images/BookNow1.jpg'" 
						onmouseover="this.src = 'Images/BookNow2.jpg'"></A>
					</P>
			<%
	}else{
		%>
