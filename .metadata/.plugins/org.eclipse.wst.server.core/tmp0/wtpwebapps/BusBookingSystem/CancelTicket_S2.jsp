...
<div id='infodiv'></div>
<P align=right>
	<A onclick="setAction('CancelTicket_S3.jsp',this)" target="ResultFrame"><IMG SRC="Images/CancelTicket0.jpg" border="0"
	onmouseout="this.src = 'Images/CancelTicket0.jpg'" 
	onmouseover="this.src = 'Images/CancelTicket1.jpg'"></A>
</P>
<%
				count++;
			}
