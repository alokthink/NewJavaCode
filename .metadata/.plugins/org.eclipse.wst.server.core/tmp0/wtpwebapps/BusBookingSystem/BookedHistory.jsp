 ...
 <div class="col-xs-12 col-sm-3 col-md-4 col-lg-3">
			   <div class="news-box">
					...
					<ul class="sideNav2">
						...
						<li class="active"><a href="BookedHistory.jsp">View Booked History</a></li>
...
try{
	...
	if(NumRows>0){
		...
		%> <P align='CENTER'><IMG SRC="Images/error.gif" WIDTH="17" HEIGHT="13" BORDER="0" ALT=""><FONT COLOR="red" face='Georgia' size='6'>No tickets found. Please Book Now And Continue</FONT><BR>
