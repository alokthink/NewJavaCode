...
<body>
<HR>
<B><FONT COLOR="Red" face='verdana' size="5"><center>Payment</center></FONT></B>
<HR>
<BR><BR>
<FORM>
<%
...
%>
	<TABLE width="60%" align=center>
		...
		<TR class="row_odd">
				...
				<TD><Input type=text name='CustomerId' value=' <%="C "+CustomerId%>' readonly ></TD>
		</TR>
		<TR class="row_even">
	...
	<div id='infodiv'></div>
<P align=right>
	<A onclick="if(document.getElementById('infodiv').innerHTML.indexOf('success')>-1){setAction('BookNow_S4.jsp',this)}else{alert('Payment details is mandatory');}" ><IMG SRC="Images/Confirm1.jpg" border="0"
	onmouseout="this.src = 'Images/Confirm1.jpg'" 
	onmouseover="this.src = 'Images/Confirm2.jpg'"></A>
</P>
</FORM>
</BODY>
</HTML>
