...
public class Customer_address_identifier  implements java.io.Serializable {
	...
	public String toString() {
		return "Customer_address_identifier [customer_identifier=" + customer_identifier + ", customer_address_seq="
				+ customer_address_seq + ", __equalsCalc=" + __equalsCalc + ", __hashCodeCalc=" + __hashCodeCalc + "]";
	}
