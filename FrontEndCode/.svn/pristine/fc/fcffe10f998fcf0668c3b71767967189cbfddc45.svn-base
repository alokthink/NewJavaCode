...
public class Payment_add_request  implements java.io.Serializable {
    ...
    /**
     * Gets the user_login_data value for this Payment_add_request.
     * 
    ...
    /**
     * Sets the user_login_data value for this Payment_add_request.
     * 
    ...
    /**
     * Gets the customer_identifier value for this Payment_add_request.
     * 
    ...
    /**
     * Sets the customer_identifier value for this Payment_add_request.
     * 
    ...
    /**
     * Gets the payment_add_data value for this Payment_add_request.
     * 
    ...
    /**
     * Sets the payment_add_data value for this Payment_add_request.
     * 
    ...
    /**
     * Gets the item_payment value for this Payment_add_request.
     * 
     * @return item_payment
     */
    ...
    /**
     * Sets the item_payment value for this Payment_add_request.
     * 
     * @param item_payment
     */
    ...
    /**
     * Gets the px_identifier value for this Payment_add_request.
     * 
    ...
    /**
     * Sets the px_identifier value for this Payment_add_request.
     * 
     * @param px_identifier
     */
    ...
    /**
     * Gets the dsn value for this Payment_add_request.
     * 
     * @return dsn
     */
    ...
    /**
     * Sets the dsn value for this Payment_add_request.
     * 
     * @param dsn
     */
    ...
    /**
     * Gets the submit value for this Payment_add_request.
     * 
     * @return submit
     */
    ...
    /**
     * Sets the submit value for this Payment_add_request.
     * 
     * @param submit
     */
    ...
    /**
     * Gets the doc_ref_id value for this Payment_add_request.
     * 
     * @return doc_ref_id
     */
    ...
    /**
     * Sets the doc_ref_id value for this Payment_add_request.
     * 
     * @param doc_ref_id
     */
    ...
    /**
     * Gets the check_missing_fields value for this Payment_add_request.
     * 
    ...
    /**
     * Sets the check_missing_fields value for this Payment_add_request.
     * 
    ...
    /**
     * Gets the suppress_events value for this Payment_add_request.
     * 
    ...
    /**
     * Sets the suppress_events value for this Payment_add_request.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Payment_add_request)) return false;
        Payment_add_request other = (Payment_add_request) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Payment_add_request.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">payment_add_request"));
	...
	public String toString() {
		return "Payment_add_request [user_login_data=" + user_login_data + ", customer_identifier="
				+ customer_identifier + ", payment_add_data=" + payment_add_data + ", item_payment="
				+ Arrays.toString(item_payment) + ", px_identifier=" + px_identifier + ", dsn=" + dsn + ", submit="
				+ submit + ", doc_ref_id=" + doc_ref_id + ", check_missing_fields=" + check_missing_fields
				+ ", suppress_events=" + suppress_events + ", __equalsCalc=" + __equalsCalc + ", __hashCodeCalc="
				+ __hashCodeCalc + "]";
	}
