...
public interface CustomerLoginDao {
	...
	List<DistributionMethodModel> retrieveDistributionMethodsFromDataSource();
	List<DistributionAttributeModel> retrieveDistributionAttributesFromDataSource();
	List<DistributionValueModel> retrieveDistributionValuesFromDataSource();
}
