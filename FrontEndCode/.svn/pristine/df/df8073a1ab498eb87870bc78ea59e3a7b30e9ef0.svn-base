...
public class Customer  extends Think.XmlWebServices.ZZCustomer  implements java.io.Serializable {
	...
	public String toString() {
		return "Customer [customer_address=" + Arrays.toString(customer_address) + ", customer_prospect="
				+ Arrays.toString(customer_prospect) + ", customer_login=" + Arrays.toString(customer_login)
				+ ", customer_group=" + customer_group + ", agency=" + agency + ", distributor=" + distributor
				+ ", group_member=" + Arrays.toString(group_member) + ", service=" + Arrays.toString(service)
				+ ", payment_account=" + Arrays.toString(payment_account) + ", customer_note="
				+ Arrays.toString(customer_note) + ", ip_address=" + Arrays.toString(ip_address) + ", auxiliary_data="
				+ Arrays.toString(auxiliary_data) + ", __equalsCalc=" + __equalsCalc + ", __hashCodeCalc="
				+ __hashCodeCalc + "]";
	}
