...
public class Order_item  extends Think.XmlWebServices.ZZOrderItem  implements java.io.Serializable {
	...
	public String toString() {
		return "Order_item [order_item_amt_break=" + Arrays.toString(order_item_amt_break) + ", order_item_install="
				+ order_item_install + ", suspension=" + Arrays.toString(suspension) + ", auxiliary_data="
				+ Arrays.toString(auxiliary_data) + ", cc_commission_amount=" + cc_commission_amount
				+ ", cc_delivery_amount=" + cc_delivery_amount + ", cc_item_amount=" + cc_item_amount
				+ ", cc_tax_amount=" + cc_tax_amount + ", cc_total_amount=" + cc_total_amount + ", cc_amount_due="
				+ cc_amount_due + ", cc_amount_due_paycurr=" + cc_amount_due_paycurr + ", cc_sum_of_paybreaks="
				+ cc_sum_of_paybreaks + ", cc_refundable_amount_paycurr=" + cc_refundable_amount_paycurr
				+ ", cc_pay_currency=" + cc_pay_currency + ", __equalsCalc=" + __equalsCalc + ", __hashCodeCalc="
				+ __hashCodeCalc + "]";
	}
