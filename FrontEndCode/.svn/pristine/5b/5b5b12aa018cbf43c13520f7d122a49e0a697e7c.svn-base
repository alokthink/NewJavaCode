...
public class Config_select_responseConfig  implements java.io.Serializable {
    ...
    private int admin_origin_address_id;  // attribute

    private int primary_shipping_address_id;  // attribute

    private int enable_vrtx_tax_calculation;  // attribute

    private java.lang.String vrtx_web_service_url;  // attribute

    private java.lang.String vrtx_trusted_id;  // attribute

    private java.lang.String company_code;  // attribute
    ...
    public Config_select_responseConfig(
           ...
           int admin_origin_address_id,
           int primary_shipping_address_id,
           int enable_vrtx_tax_calculation,
           java.lang.String vrtx_web_service_url,
           java.lang.String vrtx_trusted_id,
           ...
           this.admin_origin_address_id = admin_origin_address_id;
           this.primary_shipping_address_id = primary_shipping_address_id;
           this.enable_vrtx_tax_calculation = enable_vrtx_tax_calculation;
           this.vrtx_web_service_url = vrtx_web_service_url;
           this.vrtx_trusted_id = vrtx_trusted_id;
    ...
    /**
     * Gets the admin_origin_address_id value for this Config_select_responseConfig.
     * 
     * @return admin_origin_address_id
     */
    public int getAdmin_origin_address_id() {
        return admin_origin_address_id;
    }


    /**
     * Sets the admin_origin_address_id value for this Config_select_responseConfig.
     * 
     * @param admin_origin_address_id
     */
    public void setAdmin_origin_address_id(int admin_origin_address_id) {
        this.admin_origin_address_id = admin_origin_address_id;
    }


    /**
     * Gets the primary_shipping_address_id value for this Config_select_responseConfig.
     * 
     * @return primary_shipping_address_id
     */
    public int getPrimary_shipping_address_id() {
        return primary_shipping_address_id;
    }


    /**
     * Sets the primary_shipping_address_id value for this Config_select_responseConfig.
     * 
     * @param primary_shipping_address_id
     */
    public void setPrimary_shipping_address_id(int primary_shipping_address_id) {
        this.primary_shipping_address_id = primary_shipping_address_id;
    }
    ...
    /**
     * Gets the vrtx_trusted_id value for this Config_select_responseConfig.
     * 
     * @return vrtx_trusted_id
     */
    public java.lang.String getVrtx_trusted_id() {
        return vrtx_trusted_id;
    }


    /**
     * Sets the vrtx_trusted_id value for this Config_select_responseConfig.
     * 
     * @param vrtx_trusted_id
     */
    public void setVrtx_trusted_id(java.lang.String vrtx_trusted_id) {
        this.vrtx_trusted_id = vrtx_trusted_id;
    }


    /**
     * Gets the company_code value for this Config_select_responseConfig.
     * 
     * @return company_code
     */
    ...
    /**
     * Sets the company_code value for this Config_select_responseConfig.
     * 
     * @param company_code
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            this.admin_origin_address_id == other.getAdmin_origin_address_id() &&
            this.primary_shipping_address_id == other.getPrimary_shipping_address_id() &&
            ...
            ((this.vrtx_trusted_id==null && other.getVrtx_trusted_id()==null) || 
             (this.vrtx_trusted_id!=null &&
              this.vrtx_trusted_id.equals(other.getVrtx_trusted_id()))) &&
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += getAdmin_origin_address_id();
        _hashCode += getPrimary_shipping_address_id();
        _hashCode += getEnable_vrtx_tax_calculation();
        if (getVrtx_web_service_url() != null) {
            _hashCode += getVrtx_web_service_url().hashCode();
        }
        if (getVrtx_trusted_id() != null) {
            _hashCode += getVrtx_trusted_id().hashCode();
        }
    ...
    static {
        ...
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("admin_origin_address_id");
        attrField.setXmlName(new javax.xml.namespace.QName("", "admin_origin_address_id"));
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("primary_shipping_address_id");
        attrField.setXmlName(new javax.xml.namespace.QName("", "primary_shipping_address_id"));
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
        ...
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("vrtx_trusted_id");
        attrField.setXmlName(new javax.xml.namespace.QName("", "vrtx_trusted_id"));
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
        attrField.setFieldName("company_code");
        attrField.setXmlName(new javax.xml.namespace.QName("", "company_code"));
        attrField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        typeDesc.addFieldDesc(attrField);
        attrField = new org.apache.axis.description.AttributeDesc();
