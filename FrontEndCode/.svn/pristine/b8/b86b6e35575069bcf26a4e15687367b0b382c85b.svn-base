...
public class Item_data  implements java.io.Serializable {
	...
	public String toString() {
		return "Item_data [subscrip_id=" + subscrip_id + ", renewed_from_subscrip_id=" + renewed_from_subscrip_id
				+ ", order_code_id=" + order_code_id + ", source_code_id=" + source_code_id + ", product_id="
				+ product_id + ", subscription_def_id=" + subscription_def_id + ", pkg_item_seq=" + pkg_item_seq
				+ ", pkg_def_id=" + pkg_def_id + ", pkg_content_seq=" + pkg_content_seq + ", shipping_price_list="
				+ shipping_price_list + ", addon_to_orderhdr_id=" + addon_to_orderhdr_id + ", addon_to_order_item_seq="
				+ addon_to_order_item_seq + ", addon_to=" + addon_to + ", quantity=" + quantity + ", order_date="
				+ order_date + ", order_qty=" + order_qty + ", bundle_qty=" + bundle_qty + ", extended_days="
				+ extended_days + ", ext_iss_tot=" + ext_iss_tot + ", n_items_per_seg=" + n_items_per_seg
				+ ", issue_publication_date=" + issue_publication_date + ", electronic_document_identifier="
				+ electronic_document_identifier + ", qual_date=" + qual_date + ", squal_date=" + squal_date
				+ ", billing_type=" + billing_type + ", is_proforma=" + is_proforma + ", installment_plan_id="
				+ installment_plan_id + ", installment_data=" + installment_data + ", delivery_method="
				+ delivery_method + ", start_date=" + start_date + ", start_issue_id=" + start_issue_id
				+ ", agency_customer_id=" + agency_customer_id + ", agent_ref_nbr=" + agent_ref_nbr
				+ ", order_category=" + order_category + ", rate_class_id=" + rate_class_id
				+ ", rate_class_effective_seq=" + rate_class_effective_seq + ", ratecard_seq=" + ratecard_seq
				+ ", ex_rate_class_id=" + ex_rate_class_id + ", ex_rate_class_effective_seq="
				+ ex_rate_class_effective_seq + ", ex_ratecard_seq=" + ex_ratecard_seq + ", discount_class_id="
				+ discount_class_id + ", disc_class_effective_seq=" + disc_class_effective_seq + ", discount_card_seq="
				+ discount_card_seq + ", multiline_discount_schedule=" + multiline_discount_schedule
				+ ", multiline_disc_eff_seq=" + multiline_disc_eff_seq + ", manual_disc_amt_local="
				+ manual_disc_amt_local + ", manual_disc_amt_base=" + manual_disc_amt_base + ", manual_disc_percentage="
				+ manual_disc_percentage + ", renewal_status=" + renewal_status + ", auto_payment=" + auto_payment
				+ ", payment_account_seq=" + payment_account_seq + ", cancel_reason=" + cancel_reason + ", bill_date="
				+ bill_date + ", currency=" + currency + ", expire_date=" + expire_date + ", audit_qual_category="
				+ audit_qual_category + ", audit_name_title_id=" + audit_name_title_id + ", audit_qual_source_id="
				+ audit_qual_source_id + ", audit_sales_channel_id=" + audit_sales_channel_id
				+ ", audit_subscription_type_id=" + audit_subscription_type_id + ", customer_address_seq="
				+ customer_address_seq + ", bill_to_customer_id=" + bill_to_customer_id
				+ ", bill_to_customer_address_seq=" + bill_to_customer_address_seq + ", renew_to_customer_id="
				+ renew_to_customer_id + ", renew_to_customer_address_seq=" + renew_to_customer_address_seq
				+ ", alt_ship_customer_id=" + alt_ship_customer_id + ", alt_ship_customer_address_seq="
				+ alt_ship_customer_address_seq + ", group_order=" + group_order + ", deal_id=" + deal_id
				+ ", invoice_id=" + invoice_id + ", invoice_date=" + invoice_date + ", item_amt_break_data="
				+ Arrays.toString(item_amt_break_data) + ", auxiliary_data=" + Arrays.toString(auxiliary_data)
				+ ", generic_promotion_code_seq=" + generic_promotion_code_seq + ", temp_id=" + temp_id
				+ ", content_of=" + content_of + ", premium_to=" + premium_to + ", bill_to_address_of="
				+ bill_to_address_of + ", renew_to_address_of=" + renew_to_address_of + ", alt_ship_address_of="
				+ alt_ship_address_of + ", quick_order_code_id=" + quick_order_code_id
				+ ", pay_currency_amount_to_apply=" + pay_currency_amount_to_apply + ", threshold_option="
				+ threshold_option + ", already_subscribed=" + already_subscribed + ", candidate_subscrip_id="
				+ candidate_subscrip_id + ", ambiguous=" + ambiguous + ", bill_to_address_different_than_default="
				+ bill_to_address_different_than_default + ", renew_to_address_different_than_default="
				+ renew_to_address_different_than_default + ", not_fully_paid=" + not_fully_paid
				+ ", back_issues_missed_since=" + back_issues_missed_since + ", include_tax=" + include_tax
				+ ", expire_date_altered=" + expire_date_altered + ", ignore_bad_credit=" + ignore_bad_credit
				+ ", use_inactive_source=" + use_inactive_source + ", suppress_required_demog="
				+ suppress_required_demog + ", suppress_audit_check=" + suppress_audit_check
				+ ", suppress_payment_acct_seq=" + suppress_payment_acct_seq + ", send_back_issues=" + send_back_issues
				+ ", recalc_price=" + recalc_price + ", suppress_ccinfo_check=" + suppress_ccinfo_check
				+ ", restrict_currency=" + restrict_currency + ", restrict_order_class=" + restrict_order_class
				+ ", allow_volume_extend=" + allow_volume_extend + ", required_demog_questions="
				+ required_demog_questions + ", audit_data_needed=" + audit_data_needed + ", display_demog_form="
				+ display_demog_form + ", prompt_for_agency=" + prompt_for_agency + ", suppress_ref_int_check="
				+ suppress_ref_int_check + ", pkg_curr_changed=" + pkg_curr_changed + ", calc_cancel_item_price="
				+ calc_cancel_item_price + ", limit_pkg_mbr_edits=" + limit_pkg_mbr_edits
				+ ", bundle_qty_greater_than_one=" + bundle_qty_greater_than_one + ", invalid_installment_plan="
				+ invalid_installment_plan + ", proposed_start_date=" + proposed_start_date
				+ ", generic_promotion_code=" + generic_promotion_code + ", offer_effective_date="
				+ offer_effective_date + ", effective_is_expire_date=" + effective_is_expire_date + ", __equalsCalc="
