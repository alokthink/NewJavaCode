...
public class Order_add_response  implements java.io.Serializable {
    ...
    /**
     * Gets the customer_identifier value for this Order_add_response.
     * 
    ...
    /**
     * Sets the customer_identifier value for this Order_add_response.
     * 
    ...
    /**
     * Gets the customer value for this Order_add_response.
     * 
     * @return customer
     */
    ...
    /**
     * Sets the customer value for this Order_add_response.
     * 
     * @param customer
     */
    ...
    /**
     * Gets the payment_account_identifier value for this Order_add_response.
     * 
    ...
    /**
     * Sets the payment_account_identifier value for this Order_add_response.
     * 
    ...
    /**
     * Gets the payment_account value for this Order_add_response.
     * 
    ...
    /**
     * Sets the payment_account value for this Order_add_response.
     * 
    ...
    /**
     * Gets the demographic value for this Order_add_response.
     * 
     * @return demographic
     */
    ...
    /**
     * Sets the demographic value for this Order_add_response.
     * 
     * @param demographic
     */
    ...
    /**
     * Gets the subscrip value for this Order_add_response.
     * 
     * @return subscrip
     */
    ...
    /**
     * Sets the subscrip value for this Order_add_response.
     * 
     * @param subscrip
     */
    ...
    /**
     * Gets the orderhdr value for this Order_add_response.
     * 
     * @return orderhdr
     */
    ...
    /**
     * Sets the orderhdr value for this Order_add_response.
     * 
     * @param orderhdr
     */
    ...
    /**
     * Gets the cc_commission_amount value for this Order_add_response.
     * 
    ...
    /**
     * Sets the cc_commission_amount value for this Order_add_response.
     * 
    ...
    /**
     * Gets the cc_delivery_amount value for this Order_add_response.
     * 
    ...
    /**
     * Sets the cc_delivery_amount value for this Order_add_response.
     * 
    ...
    /**
     * Gets the cc_item_amount value for this Order_add_response.
     * 
    ...
    /**
     * Sets the cc_item_amount value for this Order_add_response.
     * 
    ...
    /**
     * Gets the cc_tax_amount value for this Order_add_response.
     * 
    ...
    /**
     * Sets the cc_tax_amount value for this Order_add_response.
     * 
     * @param cc_tax_amount
     */
    ...
    /**
     * Gets the cc_total_amount value for this Order_add_response.
     * 
    ...
    /**
     * Sets the cc_total_amount value for this Order_add_response.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Order_add_response)) return false;
        Order_add_response other = (Order_add_response) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Order_add_response.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Think/XmlWebServices/", ">order_add_response"));
	...
	public String toString() {
		return "Order_add_response [customer_identifier=" + Arrays.toString(customer_identifier) + ", customer="
				+ customer + ", payment_account_identifier=" + Arrays.toString(payment_account_identifier)
				+ ", payment_account=" + Arrays.toString(payment_account) + ", demographic="
				+ Arrays.toString(demographic) + ", subscrip=" + Arrays.toString(subscrip) + ", orderhdr=" + orderhdr
				+ ", cc_commission_amount=" + cc_commission_amount + ", cc_delivery_amount=" + cc_delivery_amount
				+ ", cc_item_amount=" + cc_item_amount + ", cc_tax_amount=" + cc_tax_amount + ", cc_total_amount="
				+ cc_total_amount + ", __equalsCalc=" + __equalsCalc + ", __hashCodeCalc=" + __hashCodeCalc + "]";
	}
