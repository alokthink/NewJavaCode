...
public class ZZPaymentAccount  implements java.io.Serializable {
	...
	public String toString() {
		return "ZZPaymentAccount [customer_id=" + customer_id + ", payment_account_seq=" + payment_account_seq
				+ ", ba_nbr=" + ba_nbr + ", bank_account_type=" + bank_account_type + ", bill_to_customer_address_seq="
				+ bill_to_customer_address_seq + ", bill_to_customer_id=" + bill_to_customer_id + ", branch_title="
				+ branch_title + ", card_verification_value=" + card_verification_value + ", creation_date="
				+ creation_date + ", credit_card_expire=" + credit_card_expire + ", credit_card_info="
				+ credit_card_info + ", credit_card_issue_id=" + credit_card_issue_id + ", credit_card_start_date="
				+ credit_card_start_date + ", dd_bank_description=" + dd_bank_description + ", dd_bank_name="
				+ dd_bank_name + ", dd_id_nbr_transposed=" + dd_id_nbr_transposed + ", dd_sorting_code="
				+ dd_sorting_code + ", dd_sorting_code_transposed=" + dd_sorting_code_transposed + ", dd_state="
				+ dd_state + ", description=" + description + ", expiry_notice_sent_date=" + expiry_notice_sent_date
				+ ", expiry_notice_sent_days_left=" + expiry_notice_sent_days_left + ", id_nbr=" + id_nbr
				+ ", id_nbr_last_four=" + id_nbr_last_four + ", is_active=" + is_active + ", payment_form="
				+ payment_form + ", payment_type=" + payment_type + ", secure_bank_def_id=" + secure_bank_def_id
				+ ", secure_store_id_obtained_date=" + secure_store_id_obtained_date + ", __equalsCalc=" + __equalsCalc
