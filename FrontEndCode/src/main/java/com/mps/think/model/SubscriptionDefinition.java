...
public class SubscriptionDefinition {
	...
	public String toString() {
		return "SubscriptionDefinition [subscriptionDefId=" + subscriptionDefId + ", subscriptionDef=" + subscriptionDef
				+ ", termId=" + termId + ", pubRotationId=" + pubRotationId + ", ocId=" + ocId + ", rateClassId="
				+ rateClassId + ", description=" + description + ", media=" + media + ", edition=" + edition
				+ ", renewalCardId=" + renewalCardId + ", orderCodeId=" + orderCodeId + ", subscriptionCategoryId="
				+ subscriptionCategoryId + ", allowOnInternet=" + allowOnInternet + ", tagLine=" + tagLine + ", issn="
				...
				+ ", rateClassEffectiveModel=" + rateClassEffectiveModel + ", localAmount=" + localAmount +",baseAmount="+ baseAmount + "  ]";
	}
